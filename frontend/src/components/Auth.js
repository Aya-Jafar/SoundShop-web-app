...
const LoginPage = () => {
    ...
    return (
        <section className="vh-50 d-flex align-items-center" style={{ backgroundColor: 'linear-gradient(to bottom, #e6e6e6, #cccccc)' }}>
        <div className="container-lg py-5">
            <div className="row d-flex justify-content-center align-items-center">
            <div className="col-12 col-md-10 col-lg-8 col-xl-6">
                <div className="card shadow-2-strong" style={{ 
                borderRadius: 0 ,
                width: "500px",
                ...
                <div className="card-body p-5 text-center">
                    ...
                    style={{ backgroundColor: '#dd4b39', width: '300px', borderColor: "#dd4b39" }}
                    type="submit"
                    >
